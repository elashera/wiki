...
| **Database (Mongo)** | Document-oriented, flexible | Más lento | Media |
...
JWT es una alternativa a las sesiones del servidor. En lugar de guardar la sesión en el servidor, el servidor **firma un token** que contiene los datos del usuario y se lo envía al cliente.
...
| Característica | JWT (Stateless) | Sessiones (Stateful) |
|---------------|-----------------|---------------------|
...
| REST APIs | [[11-res-todo-sobre-api-rest]] (auth en APIs REST) |
