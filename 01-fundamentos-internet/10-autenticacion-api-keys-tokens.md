# Autenticación: Tokens, API Keys y OAuth
...
| **Escopio** | Suele ser fijo | Puede tener scopes/permissions |
...
| **Algo que tienes** | Teléfono (SMS/OTP app), token hardware (YubiKey) |
...
// 2. Aplica hash iterativo (2^12 = 4096 rounds)
// 3. Almacena todo en el string: $2b$12$<salt>$<hash>
```
...
>
> NUNCA uses MD5, SHA1, SHA256 directamente para passwords. Son demaciado rápidos.
...
# Protección contra credential stuffing (usando listas de passwords filtradas)
POST /api/login
