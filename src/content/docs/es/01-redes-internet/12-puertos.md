---
title: "Puertos, localhost y loopback"
description: "Qué es un puerto, localhost vs 0.0.0.0, loopback, puertos well-known vs ephemeral, Docker networking, IPv4 vs IPv6, y cómo ver puertos abiertos."
---
...
| `0.0.0.0` | `::` | **Ninguna** | "Todas las interfaces" |
...
> El IPv4 se agotó en 2011. Con NAT (ver [[13-nat-red]]) pudimos alargar la vida, pero IPv6 es la solución definitiva. Cada dispositivo puede tener su propia IP pública.
...
| Servidores y procesos | [[14-servidores-procesos]] (un servidor es un proceso escuchando en un puerto) |
