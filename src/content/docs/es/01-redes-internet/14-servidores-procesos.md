---
title: "Servidores y procesos: qué es un servidor"
description: "Un servidor es solo un proceso. Procesos, PID, daemons, sockets, señales, modelos de concurrencia (event loop, fork, threads), gestión con PM2, Systemd y Docker."
---
...
| Reverse proxy | Nginx/Caddy como proxy |
