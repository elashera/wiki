...
description: "El sistema de nombres de dominio explicado a fondo: resolución recursiva e iterativa, tipos de registros (A, AAAA, CNAME, MX, TXT, SRV, SOA, CAA), caché, TTL, DNSSEC y herramientas CLI."
---
...
> [!tip] DNS equilibrado (round-robin)
> Un dominio puede tener múltiples registros A para la misma hostname:
> ```
...
| CDN y Cloudflare | [[04-cloudflare-intro]] |
| Let's Encrypt y certificados | [[08-lets-encrypt]] (los certificados tienen CAA en DNS) |
| HTTPS | [[07-https-tls]] |
| Nginx/Caddy como reverse proxy | [[14-servidores-procesos]] |
