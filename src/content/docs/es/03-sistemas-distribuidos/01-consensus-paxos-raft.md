---
title: "Consensus en sistemas distribuidos: Paxos, Raft y el problema de la concordia"
description: "Cómo los sistemas distribuidos se ponen de acuerdo: Paxos, Raft, el teorema CAP, y el teorema FLP. Explicado desde cero con diagramas y ejemplos prácticos."
---

# Consensus en sistemas distribuidos: Paxos, Raft y el problema de la concordia

> [!tip] Consensus en una frase
> El **consenso distribuido** es el problema de hacer que múltiples nodos, que pueden fallar en cualquier momento, se pongan de acuerdo en un valor único y consistente — sin un servidor central que mande sobre todos.
...
## 2. Paxos: El consenso en condiciones adversas
...
- [[02-message-queues]] — Las message queues usan consenso interno para replicar mensajes entre brokers
- [[03-distributed-caching]] — Redis Cluster usa un protocolo de consenso similar a Gossip para la consistencia
- [[04-event-driven-cqrs-saga]] — Los eventos distribuidos necesitan consenso para garantizar que todos los servicios vean los mismos eventos
